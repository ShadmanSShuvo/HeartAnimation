      ...
      <div className="dashboard-grid">
        ...
        <div>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 380px', gap: '2rem', marginBottom: '2rem' }}>
            ...
            {/* 3D HEART VIEWER */}
            <div className="card" style={{ padding: 0, height: '500px', overflow: 'hidden', position: 'relative' }}>
              ...
              <div style={{ position: 'absolute', bottom: '8px', right: '10px', zIndex: 10, fontSize: '0.5rem', color: '#94a3b8', background: 'rgba(15,23,42,0.7)', padding: '2px 8px', borderRadius: '4px', pointerEvents: 'none' }}>
